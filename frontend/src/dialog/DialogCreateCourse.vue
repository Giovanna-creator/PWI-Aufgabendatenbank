<template>
  ...
  >
        ...
        <v-card-text>
          <v-row>
            <v-col>
              ...
              />
              <v-text-field
                v-model="course.keyPassword"
                color="primary"
                variant="underlined"
                label="Passwort (Keep empty for public course)"
              />
            </v-col>
            <v-col>
              <v-select
                ...
                variant="underlined"
                label="Semester"
                :rules="[(v: any) => !!v || 'Semester is required']"
                required
                :items="semesters"
                item-title="name"
                return-object
              ...
              <v-select
                ...
                variant="underlined"
                label="Standort"
                :items="['Friedberg', 'Gießen']"
                :rules="[(v: any) => !!v || 'Standort is required']"
                required
              />
            </v-col>
          </v-row>
    ...
    <v-snackbar
      ...
      :timeout="2500"
    >
      Kurs konnte nicht erstellt werden, bitte versuchen Sie es erneut
    </v-snackbar>
  </v-dialog>
